...
**v1.2 Complete** — All v1.0 milestones, v1.1 Admin Dashboard, and v1.2 structural/security upgrades implemented. Post-v1.2 upgrade recommendations documented in `docs/plans/zero-drop-v1.3-recommendations.md`.
...
| 28 | 2026-06-23 | Security hardening + observability: SecurityHeaders middleware, RequestLogger, GzipMiddleware, HTTP server timeouts, enhanced health endpoint, camera fallback in reader.html, serverVersion constant, frontend CI fixes. Docs updated. New file: docs/plans/zero-drop-v1.2-upgrade-recommendations.md. |
| 29 | 2026-06-23 | Post-v1.2 recommendations documented in docs/plans/zero-drop-v1.3-recommendations.md. Prioritized P0-P3 upgrades: printer hang protection, frontend crypto tests, login rate limiter cleanup, integration tests, go:embed, TCP printer support, Prometheus metrics, and more. |
| 3 | 2026-05-11 | PRD revision v1.1: Frontend stack changed to React + Vite + shadcn/ui |
| 4 | 2026-05-11 | M-01 implementation: Go module, pkg/crypto, pkg/config |
| 5 | 2026-05-11 | M-02 implementation: pkg/api, pkg/spooler, pkg/observability |
| 6 | 2026-05-11 | M-03 implementation: pkg/printer, static/reader.html |
